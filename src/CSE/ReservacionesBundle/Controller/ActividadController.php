...
use CSE\ReservacionesBundle\Entity\Actividad;
use CSE\ReservacionesBundle\Form\ActividadType;
...
class ActividadController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CSEReservacionesBundle:Actividad:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CSEReservacionesBundle:Actividad')->find($id);
        ...
        return $this->render('CSEReservacionesBundle:Actividad:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CSEReservacionesBundle:Actividad:edit.html.twig', array(
            'entity'      => $entity,
